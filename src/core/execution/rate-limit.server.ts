...
export const DEFAULT_RATE_LIMITS: Record<string, RateLimitConfig> = {
  gamma_discovery: { capacity: 30, windowMs: 60_000, baseBackoffMs: 1_000, maxBackoffMs: 30_000 },
  clob_submit: { capacity: 20, windowMs: 60_000, baseBackoffMs: 500, maxBackoffMs: 30_000 },
  clob_fills: { capacity: 60, windowMs: 60_000, baseBackoffMs: 500, maxBackoffMs: 30_000 },
};
