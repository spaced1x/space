...
/**
 * The permanent top-of-cockpit banner. It answers, in one line, the three
 * questions an operator must never have to infer: which environment is active,
 * whether real capital is at risk, and whether trading can happen right now.
 *
...
export function RuntimeBanner({
  ...
  return (
    ...
    >
      ...
      <p className="mt-3 text-label leading-relaxed text-foreground">{tradingLine}</p>
    </section>
  );
}
